...
This attack map demonstrates the importance of securing Network Security Groups (NSG) and underscores the importance of implementing proper security controls.

![NSG Allow](https://github.com/user-attachments/assets/f8be990a-09dc-4ec7-b660-0390c4d6127d)
...
![RDP Failures](https://github.com/user-attachments/assets/dced1de9-3642-41ae-961e-f8074966c82f)
...
I re-observed the environment for another 5 to 6 hours to measure security metrics again, comparing the results with the initial baseline. Unfortunately heatmaps don't work when there are no alerts or logs to ingest.

Metrics before hardening and security control implementation:
...
| NSG Inbound Malicious Flows Allowed | 1,697 |

Metrics after hardening and security control implementation:

| **Metric** | **Count** |
|---|---|
| SecurityEvent (Windows VM) | 2,980 |
